# scale study: 960 runs · 19 PATHOLOGY (NaN/non-monotone, excluded) · 34 plateau (flat loss at the constant floor, kept)
...
|---|---|---|---|---|---|
| s264 | 0.1572±0.0119 (10/0/0/10) | 0.1230±0.0117 (10/0/0/10) | 0.1410±0.0139 (9/1/0/9) | heat 7 · qw 2 (of 9) · gain 29.2% | heat |
| s1584 | 0.1711±0.0027 (10/0/0/7) | 0.1678±0.0059 (10/0/0/5) | 0.1682±0.0053 (9/1/0/7) | heat 3 · qw 6 (of 9) · gain 2.3% | FLOOR (gain 2.3% < 5%) |
...
| shell | gcn mean±std (n used / n pathology / n plateau / beats-const) | heat mean±std (n used / n pathology / n plateau / beats-const) | qw mean±std (n used / n pathology / n plateau / beats-const) | heat vs qw: seeds won | verdict |
|---|---|---|---|---|---|
| s264 | 0.1572±0.0119 (10/0/0/10) | 0.1318±0.0172 (9/1/0/9) | 0.1575±0.0138 (10/0/0/9) | heat 9 · qw 0 (of 9) · gain 24.1% | heat |
...
| s4400 | 0.1691±0.0023 (10/0/0/3) | 0.1694±0.0021 (10/0/0/2) | 0.1693±0.0024 (9/1/0/3) | heat 6 · qw 3 (of 9) · gain -0.0% | FLOOR (gain -0.0% < 5%) |

## task=delay · arm=softplus/t0=2 · metric=mae

| shell | gcn mean±std (n used / n pathology / n plateau / beats-const) | heat mean±std (n used / n pathology / n plateau / beats-const) | qw mean±std (n used / n pathology / n plateau / beats-const) | heat vs qw: seeds won | verdict |
|---|---|---|---|---|---|
| s264 | 0.1572±0.0119 (10/0/0/10) | 0.1554±0.0224 (9/1/0/9) | 0.1547±0.0202 (10/0/0/9) | heat 4 · qw 5 (of 9) · gain 10.9% | tie |
...
| s1584 | 0.2007±0.0012 (10/0/1/10) | 0.1983±0.0050 (10/0/1/9) | 0.1956±0.0117 (9/1/1/9) | heat 3 · qw 6 (of 9) · gain 3.1% | FLOOR (gain 3.1% < 5%) |
| s3168 | 0.1773±0.0005 (10/0/1/9) | 0.1774±0.0008 (10/0/1/9) | 0.1764±0.0014 (8/2/0/8) | heat 3 · qw 5 (of 8) · gain 0.6% | FLOOR (gain 0.6% < 5%) |
...
| shell | gcn mean±std (n used / n pathology / n plateau / beats-const) | heat mean±std (n used / n pathology / n plateau / beats-const) | qw mean±std (n used / n pathology / n plateau / beats-const) | heat vs qw: seeds won | verdict |
|---|---|---|---|---|---|
| s264 | 0.1663±0.0124 (10/0/0/10) | 0.1272±0.0445 (9/1/0/9) | 0.1475±0.0317 (9/1/0/9) | heat 8 · qw 1 (of 9) · gain 32.7% | heat |
...
| s1584 | 0.2007±0.0012 (10/0/1/10) | 0.2009±0.0023 (10/0/1/9) | 0.2001±0.0063 (8/2/1/7) | heat 2 · qw 6 (of 8) · gain 0.9% | FLOOR (gain 0.9% < 5%) |
| s3168 | 0.1773±0.0005 (10/0/1/9) | 0.1770±0.0008 (10/0/1/10) | 0.1769±0.0008 (8/2/1/8) | heat 4 · qw 4 (of 8) · gain 0.4% | FLOOR (gain 0.4% < 5%) |
| s4400 | 0.1870±0.0005 (10/0/1/10) | 0.1872±0.0002 (10/0/1/10) | 0.1859±0.0019 (9/1/0/9) | heat 3 · qw 6 (of 9) · gain 0.8% | FLOOR (gain 0.8% < 5%) |

## task=hops · arm=softplus/t0=2 · metric=mae

| shell | gcn mean±std (n used / n pathology / n plateau / beats-const) | heat mean±std (n used / n pathology / n plateau / beats-const) | qw mean±std (n used / n pathology / n plateau / beats-const) | heat vs qw: seeds won | verdict |
|---|---|---|---|---|---|
| s264 | 0.1663±0.0124 (10/0/0/10) | 0.1367±0.0411 (9/1/0/9) | 0.1549±0.0331 (9/1/0/9) | heat 6 · qw 3 (of 9) · gain 27.6% | tie |
| s1584 | 0.2007±0.0012 (10/0/1/10) | 0.1996±0.0046 (9/1/1/8) | 0.1997±0.0040 (10/0/1/10) | heat 3 · qw 6 (of 9) · gain 1.1% | FLOOR (gain 1.1% < 5%) |
...
| delay | s4400 | FLOOR (gain -0.1% < 5%) | FLOOR (gain -0.1% < 5%) | FLOOR (gain -0.0% < 5%) | FLOOR (gain -0.1% < 5%) | FLOOR |
| hops | s264 | tie | heat | tie | tie | no |
| hops | s1584 | FLOOR (gain 3.1% < 5%) | FLOOR (gain 1.6% < 5%) | FLOOR (gain 0.9% < 5%) | FLOOR (gain 1.1% < 5%) | FLOOR |
| hops | s3168 | FLOOR (gain 0.6% < 5%) | FLOOR (gain 0.2% < 5%) | FLOOR (gain 0.4% < 5%) | FLOOR (gain 0.3% < 5%) | FLOOR |
| hops | s4400 | FLOOR (gain 1.0% < 5%) | FLOOR (gain 0.2% < 5%) | FLOOR (gain 0.8% < 5%) | FLOOR (gain 0.2% < 5%) | FLOOR |

## Learned propagation time t (mean over valid runs, per layer)

| task | shell | arm | heat t | qw t |
|---|---|---|---|---|
| delay | s264 | relu/t0=0.5 | [1.88, 0.05, -0.17, -0.17] | [0.80, 0.19, 0.09, 0.02] |
| delay | s264 | relu/t0=2 | [1.43, 0.35, 0.21, -0.22] | [0.80, 0.29, 0.29, 0.19] |
| delay | s264 | softplus/t0=0.5 | [1.03, 0.30, 0.20, 0.18] | [1.12, 0.65, 0.62, 0.64] |
| delay | s264 | softplus/t0=2 | [0.83, 0.38, 0.32, 0.30] | [0.82, 0.52, 0.50, 0.46] |
| delay | s1584 | relu/t0=0.5 | [1.21, 0.34, 0.07, -0.01] | [0.55, 0.35, 0.11, 0.17] |
...
| delay | s4400 | softplus/t0=0.5 | [0.94, 0.30, 0.08, 0.08] | [0.79, 0.67, 0.24, 0.29] |
...
| hops | s264 | relu/t0=2 | [1.71, 0.71, 0.12, -0.12] | [1.03, 0.56, 0.39, 0.28] |
| hops | s264 | softplus/t0=0.5 | [1.32, 0.41, 0.25, 0.19] | [1.34, 0.87, 0.67, 0.69] |
| hops | s264 | softplus/t0=2 | [1.20, 0.64, 0.45, 0.34] | [0.97, 0.66, 0.58, 0.50] |
| hops | s1584 | relu/t0=0.5 | [1.26, 0.13, 0.08, 0.07] | [0.29, 0.48, 0.14, 0.38] |
| hops | s1584 | relu/t0=2 | [1.44, 0.29, 0.06, -0.17] | [1.00, 0.59, 0.58, 0.36] |
| hops | s1584 | softplus/t0=0.5 | [1.06, 0.20, 0.09, 0.09] | [0.67, 0.64, 0.51, 0.58] |
| hops | s1584 | softplus/t0=2 | [1.23, 0.48, 0.52, 0.39] | [1.03, 0.54, 0.51, 0.51] |
| hops | s3168 | relu/t0=0.5 | [1.29, -0.13, -0.15, -0.15] | [0.59, 0.75, 0.15, 0.10] |
| hops | s3168 | relu/t0=2 | [1.32, -0.05, -0.15, -0.17] | [0.94, 0.29, 0.32, 0.38] |
| hops | s3168 | softplus/t0=0.5 | [1.07, 0.24, 0.09, 0.08] | [0.78, 0.70, 0.32, 0.29] |
...
| hops | s4400 | softplus/t0=0.5 | [1.09, 0.24, 0.09, 0.09] | [0.71, 0.76, 0.52, 0.54] |
